...
const en = {
  ...
  cameras: {
    ...
    keyenceService: 'Image server', keyenceServiceOn: 'Running, always ready to receive',
    keyenceServiceOff: 'Not running', keyenceSince: 'Pictures received since start',
...
const sl = {
  ...
  cameras: {
    ...
    keyenceService: 'Strežnik za slike', keyenceServiceOn: 'Teče, vedno pripravljen na sprejem',
    keyenceServiceOff: 'Ne teče', keyenceSince: 'Prejetih slik od zagona',
